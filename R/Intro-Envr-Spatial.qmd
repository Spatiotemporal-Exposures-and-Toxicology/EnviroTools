...
This vignette will introduce packages equipped to handle the various types of data often used in environmental research. The vignette will also show/teach how to perform various analyses for each unique type of spatial data. 

This vignette will introduce functions and packages designed to handle various types of spatial data, and will teach users how to perform primary analyses for each. Primary analyses include:
...
The terminology in this vignette assumes users' basic understanding of spatial data, including point, polygon, and raster data types. Please see [1. Simple Features for R](https://r-spatial.github.io/sf/articles/sf1.html#what-is-a-feature) for more information on point and polygon data types, and  [Introduction to Raster Data](https://datacarpentry.org/organization-geospatial/01-intro-raster-data) for more information on raster data.
...
Histograms help visualize the distribuation of the data. Create a histogram by adding `ggplot2::geom_histogram()` as an argument to the `ggplot2::ggplot()` function.
...
This concludes section 2.2 Polygon data with `terra`. Unit 2 of this vignette series will explore more specific analyses that can be conducted with `terra` polygon data.
...
This concludes section 3. Raster Data. Unit 2 of this vignette series will explore more specific analyses that can be conducted with `terra` polygon data.

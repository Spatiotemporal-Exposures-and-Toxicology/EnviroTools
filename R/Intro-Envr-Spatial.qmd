...
library(sf); library(ggplot2); library(ggpubr)
map = st_read("/Volumes/SET/Projects/EnviroTools/input/states/cb_2018_us_state_500k.shp")
map = subset(map, subset = !NAME %in% c("Alaska",
                                        "Hawaii",
                                        "Puerto Rico",
